...
public class Main {
    public static void main(String[] args) {
        ...
        ItemStack stack = ItemStack.of(Material.STICK, 1)
                ...
                .with(ItemComponent.POTION_CONTENTS, new PotionContents(PotionType.ABSORPTION, new Color(83), List.of(new PotionDetails(PotionType.BAD_OMEN, 1, 1))))
                .with(ItemComponent.FOOD, new FoodComponent(3, false, true, 0.7f, List.of(new ProbablePotionDetails(new PotionDetails(PotionType.ABSORPTION, 0, 0), 0.5f))))
